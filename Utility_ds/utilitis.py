...
class LinkedList:
    ...
    def append(self, data):
        ...
        if self.head is None:
            ...
            while current.next is not None:  # else traverse pointer till last node and
                current = current.next  # append new node at end
    ...
    def remove(self, data):
        ...
        if current.data == data:
            self.head = current.next  # for first node of linked list
            return
        ...
        while current.next is not None:
            ...
            if temp.data == data:           # matching
                current.next = temp.next  # if data match with node then delete
                return
    ...
    def display(self):
        ...
        while current.next is not None:
            list1.append(current.data)  # append element in list till linked list not end
            current = current.next
    ...
    def file_update(self, data):
        ...
        """
        global list1_content
        file = open("/home/shadowk/PycharmProjects/Programs_BridgeLab/Week2/Utility_ds/test2.txt", "r+")
        file.truncate(0)
        file.close()
        if self.search_item(data) is True:      # search data using search method
            self.remove(data)                   # if found then remove

            file = open("/home/shadowk/PycharmProjects/Programs_BridgeLab/Week2/Utility_ds/test2.txt", "a+")
            list1_content = []
            list1_content = self.display()  # assign linked list to a list
            for i in list1_content:
...
class Stack:
    ...
    def push(self, data):
        ...
        if self.head is None:
            ...
            while current.next is not None:    # else add to next null position
                current = current.next
    ...
    def size(self):
        ...
        if self.head is None:
            return 0
        size = 1
        while current.next is not None:    # traverse pointer till last node and
            current = current.next        # for each node size increment by 1
            size += 1
    ...
    def show(self):
        ...
        while current.next is not None:
            print(current.data)        # print element of stack
            current = current.next
        print(current.data)
    ...
    def pop(self):
        ...
        if self.head.next is None:
            ...
            return current.data        # set head as none and delete that element and return data
    ...
    def peek(self):
        ...
        for i in range(0, self.top):
            current = current.next    # traverse pointer till last node

        return current.data            # return last node which is top element
...
class OrderedList:
    ...
    def add(self, data):
        ...
        if self.head is None:  # if list is empty
            ...
            if int(self.head.data) > int(node.data):  # compare data before adding it
                ...
                node.next = current  # than given data then simply add it.

            if int(self.head.data) < int(node.data):  # if head of data less than new node of data
                temp = self.head
                while current.next is not None:
                    if current.data < node.data:
                        temp = current  # check where new node of data is less than
                    current = current.next  # next one and if condition satisfy then add
    ...
    def remove(self, data):
        ...
        current = self.head
        temp = self.head
        if current.data == data:       # if element found at first position then
            self.head = current.next   # increment head and remove that element
            return
    ...
    def search_item(self, data):
        ...
        while current.next is not None:
            ...
            if current.data == data:  # data matching
                    return True
            current = current.next
        if current.data == data:       # if found return true else return false
              return True
        else:
              return False
    ...
    def display(self):
        ...
        while current.next is not None:
            l1.append(current.data)  # append data into list
            current = current.next
    ...
    def file_update(self, data):
        ...
        """
        global l1_content
        file = open("/home/shadowk/PycharmProjects/Programs_BridgeLab/Week2/Utility_ds/Number.txt", "r+")
        file.truncate(0)
        file.close()
        ...
        if self.search_item(data) is True:              # if element found
            ...
            file = open("/home/shadowk/PycharmProjects/Programs_BridgeLab/Week2/Utility_ds/Number.txt", "a+")
...
class Queue:
    ...
    def size(self):
        ...
        while current.next is not None:
            current = current.next        # traverse till last element and count size
            size += 1
        return size
    ...
    def display_content_hashtable(self):
        ...
        for i in range(0, len(self.objects_list)):
            ...
            if self.objects_list[i].display() is not None:
                ...
                file = open("/home/shadowk/PycharmProjects/Programs_BridgeLab/Week2/Utility_ds/Number.txt", "a+")   # by display function
                for j in lines:
                    file.write(str(j) + ' ')
...
class Methods:
    ...
    def anagram_stack(self):
        ...
        """
        for i in anagram_prime():  # get anagram numbers which are prime
...
# =======================================================================================
    def prime_number_2d_array(self):
        ...
        prime_list = prime_num()  # get prime number
        row = 10
        column = 25
        limit = 100
...
# ======================================================================================
    def anagram_2d_array(self):
        ...
        """
        prime_list = prime_num()  # get prime numbers
        anagram_list = anagram_prime()  # get anagram numbers which is prime also
        not_anagram = []
        row = 10
        column = 25
...
class Cal_Methods:
    ...
    def calendar(self, month, year):
        ...
        if check_Leap(year):      # check leap year
            days[1] = 29
        row = 6
        column = 7
        two_d_array = [[0 for j in range(column)] for i in range(row)]
        # create empty 2d array
        print('\nYour Calender is')
        if month == 1: print('Jan',year)
        elif month == 2: print('Feb',year)
        elif month == 3: print('March',year)
        elif month == 4: print('April',year)
        elif month == 5: print('May',year)
        elif month == 6: print('Jun',year)
        elif month == 7: print('July',year)
        elif month == 8: print('August',year)
        elif month == 9: print('Sept',year)
        elif month == 10: print('Oct', year)
        elif month == 11: print('Nov', year)
        elif month == 12: print('Dec', year,'\n')
        print('')
        ...
        for i in range(row):
            ...
            for j in range(column):
                if queue.size() > 0:
                    ...
                    x1 = str(x).ljust(2)    # using  method print formatted calender
                    print(x1, end=" ")
            print()
