from Week2.Utility_ds.utilitis import HashTable
...
def hashing_runner():
    ...
    file = open("/home/shadowk/PycharmProjects/Programs_BridgeLab/Week2/Utility_ds/Number.txt", "r")     # opening the file to read using functions
    print(file.readline())
    try:
